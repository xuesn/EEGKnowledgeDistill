...
class model_SCT(nn.Module):
    ...
    # 降维（时间维度加权），再接fc分类--------------------------------------------------
        ...
        def compute_conv_out_time_dim_nopooling(kernal1, kernal2, kernal3, timepoint_num):
            conv_out_time_dim_nopooling = timepoint_num-kernal1+1-kernal2+1-kernal3+1
            return int(conv_out_time_dim_nopooling)
        conv_out_time_dim = compute_conv_out_time_dim_nopooling(kernal1, kernal2, kernal3, timepoint_num)
