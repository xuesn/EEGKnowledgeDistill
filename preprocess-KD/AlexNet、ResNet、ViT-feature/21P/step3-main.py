...
# # 5、训练linear
# new_feat_save_path = '/data/snxue/visual_embedding/21Purdue/prob/'
...
# # ----------------------------------------------------------------------------------------------------
# #读取 原特征 和 对应图片类别
# vis_feat_path='/data/snxue/visual_embedding/21Purdue/'
...
#     trainset = torch.utils.data.TensorDataset(torch.tensor(sample_feature), torch.tensor(label_onehot_40000))
